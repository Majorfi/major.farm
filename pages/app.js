	...
	return (
		<div>
			<div id={'newsbanner'} className={'space-y-0.5'}>
				<NewsBanner
					bannerID={'newsBanner-7'}
					short={'Some new vaults from ape.tax are now available'}
					long={'True Cereal 🔵🥣, Spooky Stars 👻✨, Compounding Cosmos 📈✨ & Interstellar Sushi ✨🍣 from ape.tax are now available for tracking !'}
					uri={'https://ape.tax'} />
			</div>
			<Stats />
