...
export const CurrenciesContextApp = ({children}) => {
	...
	const updateCurrency = async (_baseCurrency) => {
		...
		const	cryptoListObj = {
			...
			'matic': {price: 0, fetchID: 'matic-network'},
			'fantom': {price: 0, fetchID: 'fantom'},
			'btc': {price: 0, fetchID: 'bitcoin'},
			'yearn-lazy-ape': {price: 0, fetchID: 'yearn-lazy-ape'},
			'assy-index': {price: 0, fetchID: 'assy-index'},
			'concentrated-voting-power': {price: 0, fetchID: 'concentrated-voting-power'},
			'usd-coin': {price: 0, fetchID: 'usd-coin'},
			'bag': {price: 0, fetchID: 'blockchain-adventurers-guild'},
			'pickle-finance': {price: 0, fetchID: 'pickle-finance'},
			'yvboost': {price: 0, fetchID: 'yvboost'},
			'badger-dao': {price: 0, fetchID: 'badger-dao'},
			'rai': {price: 0, fetchID: 'rai'},
			'dai': {price: 0, fetchID: 'dai'},
			'havven': {price: 0, fetchID: 'havven'},
			'ice-token': {price: 0, fetchID: 'ice-token'},
			'sushi': {price: 0, fetchID: 'sushi'},
			'nusd': {price: 0, fetchID: 'nusd'},
			'uniswap': {price: 0, fetchID: 'uniswap'},
			'true-usd': {price: 0, fetchID: 'true-usd'},
			'tether': {price: 0, fetchID: 'tether'},
			'aave': {price: 0, fetchID: 'aave'},
			'alchemix': {price: 0, fetchID: 'alchemix'},
			'pooltogether': {price: 0, fetchID: 'pooltogether'},
			'usdp': {price: 0, fetchID: 'usdp'},
			'link': {price: 0, fetchID: 'link'},
			'yearn-finance': {price: 0, fetchID: 'yearn-finance'},
			'1inch': {price: 0, fetchID: '1inch'},
			'woofy': {price: 0, fetchID: 'woofy'},
			'spookyswap': {price: 0, fetchID: 'spookyswap'},
			'binancecoin': {price: 0, fetchID: 'binancecoin'},
			'nerve-finance': {price: 0, fetchID: 'nerve-finance'},
			'hegic': {price: 0, fetchID: 'hegic'},
		}
